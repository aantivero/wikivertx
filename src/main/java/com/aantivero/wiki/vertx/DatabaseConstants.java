...
/**
 * Parameters configuration and default values
 */
public interface DatabaseConstants {
	...
	String DEFAULT_WIKI_JDBC_URL = "jdbc:hsqldb:file:db/wiki";
	String DEFAULT_WIKI_JDBC_DRIVER_CLASS = "org.hsqldb.jdbcDriver";
